...
set output "fig2_ul2_miss_norm_vs_degree.png"
set grid ytics
set xlabel "Prefetch degree"
set ylabel "Normalized UL2 miss rate (baseline=1)"
set key outside
set xtics ("1" 1, "2" 2, "4" 4, "8" 8, "16" 16)
set xrange [0.5:16.5]

plot "plot_ul2_miss_norm.tsv" using 1:2 with linespoints title "cc1", \
